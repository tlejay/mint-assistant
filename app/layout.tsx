...
export default function RootLayout({
 ...
 >
 <body className="min-h-full flex flex-col bg-rose-50/40 text-zinc-900">
 ...
 target="_blank"
 rel="noreferrer"
 className="text-zinc-700 hover:text-rose-700 transition-colors"
 >
 {l.label}
 </a>
 ) : (
 ...
 <footer className="border-t border-rose-200/60 py-6 text-center text-xs text-zinc-600">
