...
export default function Home() {
 ...
 className="font-medium text-rose-700 underline decoration-rose-300 hover:text-rose-900"
 >
 madebytle.com
 </a>
 </p>
 ...
 <div
 key={t.name}
 className="rounded-2xl border border-pink-100 bg-white/70 p-5 shadow-sm transition hover:shadow-md"
 >
 ...
 <div
 key={c.title}
 className="flex items-start gap-3 rounded-xl border border-pink-100 bg-white/60 p-4"
 >
 <div className="text-2xl">{c.icon}</div>
 <div className="min-w-0">
 <p className="font-medium">{c.title}</p>
 <p className="mt-1 text-xs leading-5 text-zinc-600 [overflow-wrap:anywhere]">
 {c.body}
 </p>
 </div>
 </div>
 ...
 <Link
 href={t.href}
 className="block rounded-2xl border border-pink-100 bg-gradient-to-br from-pink-50 to-violet-50 p-5 transition hover:shadow-md"
 >
 ...
 <details className="rounded-xl border border-pink-100 bg-white/60 p-4">
 ...
 <section className="rounded-2xl bg-gradient-to-br from-pink-100 via-violet-100 to-cyan-100 p-6">
 <h2 className="text-lg font-semibold sm:text-xl">
 อยากสร้าง AI assistant แบบนี้บ้าง
 </h2>
 <p className="mt-3 text-sm leading-6 text-zinc-800 [overflow-wrap:anywhere]">
